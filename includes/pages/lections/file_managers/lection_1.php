<div class="lection">
    ...
    <h1>Лекция 1: "Управление виртуальной памятью"</h1>
    ...
    <a href="includes/lection_handler.php?section=oper_sys&topic=file_managers&page=lection&num=1"><button class="complete-btn">Продолжить</button></a>
</div>