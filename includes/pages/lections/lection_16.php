<div class="lection">
    ...
    <h1>Лекция 6: " Работа приложений WINDOWS. Обмен данными между приложениями"</h1>
...
DataRequestedEventArgs>(this.OnDataRequested); <br>
    ...
    <a href="includes/lection_handler.php?section=oper_sys&topic=introduction&page=lection&num=16"><button class="complete-btn">Продолжить</button></a>
</div>