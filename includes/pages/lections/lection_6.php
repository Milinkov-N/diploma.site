<div class="lection">
    ...
    <h1>Лекция 2: "Работа с дисками"</h1>
    ...
    <a href="includes/lection_handler.php?section=oper_sys&topic=introduction&page=lection&num=6"><button class="complete-btn">Продолжить</button></a>
</div>