<div class="lection">
    ...
    <h1>Лекция 2: "Файловая система FAT"</h1>
    ...
    <a href="includes/lection_handler.php?section=oper_sys&topic=machine_independ&page=lection&num=3"><button class="complete-btn">Продолжить</button></a>
</div>