<div class="lection">
    ...
    <h1>Лекция 5: "Понятие и назначение файловой системы NFS. Работа с файлами."</h1>
...
100227 3 tcp 2049 nfs_acl
    ...
    <a href="includes/lection_handler.php?section=oper_sys&topic=machine_independ&page=lection&num=1"><button class="complete-btn">Продолжить</button></a>
</div>